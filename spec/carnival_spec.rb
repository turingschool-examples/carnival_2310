...
RSpec.describe Carnival do
  ...
  describe 'total_revenue_from_all_rides' do
    it 'returns an Integer of the carnivals global ride revenue' do
      carnival = Carnival.new(14)
      ride1 = Ride.new({ name: 'Carousel', min_height: 24, admission_fee: 1, excitement: :gentle })
      visitor1 = Visitor.new('Bruce', 54, '$12')
      visitor2 = Visitor.new('Tucker', 36, '$5')
      ...
      expect(carnival.total_revenue_from_all_rides).to eq(28)
    end
  end
end
